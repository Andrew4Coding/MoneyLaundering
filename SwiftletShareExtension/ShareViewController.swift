...
final class ShareViewController: UIViewController {
    private static let appGroupID = "group.com.andrew4coding.swiftlet.sharedData"
    private static let receiptFileName = "shared-receipt.jpg"
    private let hostAppURL = URL(string: "swiftlet://add-transaction")!
    private let log = Logger(
        subsystem: "com.andrew4coding.swiftlet.Swiftlet.SwiftletShareExtension",
        category: "share"
    )
